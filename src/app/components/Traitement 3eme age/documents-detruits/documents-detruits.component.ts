...
@Component({
  selector: 'app-documents-detruits',
  templateUrl: './documents-detruits.component.html',
  styleUrls: ['./documents-detruits.component.scss']
})
export class DocumentsDetruitsComponent implements OnInit {
 ...
 constructor( private route:ActivatedRoute, private service:SuiviDocument3emeAgeService,private _router:Router,private dialog:MatDialog) { }
  ...
  ngOnInit(): void {
   ...
   this.service.getDocumentsDeleted().subscribe(
     data=>{
