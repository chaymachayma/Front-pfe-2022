...
export class ClassementDocsComponent implements OnInit {
  ...
  doc:SuiviDoc2emeAge[]=[];
  searchValue!:string;
  displayedColumns: string[]=['code_centre','chapitre_comptable','codedocument','designation_Nomenclature','numero_document','numero_d_ordre','nombre_De_documents','date_De_creation_Du_Document','EmplSalleConservation','EmplCote','action'];
